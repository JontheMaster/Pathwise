...
class PathwiseApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Widget und Erinnerung: haelt beide auf dem Stand und oeffnet das
    // Szenario, wenn jemand dort tippt (siehe einsprung.dart).
    return PwEinsprung(
      child: MaterialApp(
        title: 'Pathwise',
        debugShowCheckedModeBanner: false,
        navigatorKey: pwNavigatorKey,
        theme: pwTheme(dark: false),
        darkTheme: pwTheme(dark: true),
        // Dunkel ist der Standard der App, nicht `system` (DESIGN.md 3).
        themeMode: modus,
        // Wer die Bewegung in den Einstellungen abschaltet, setzt damit
        // dasselbe Signal, das sonst vom System kommt. So greift die
        // Einstellung ueberall, wo PwMotion oder Flutter selbst danach
        // fragen — ohne Sonderweg.
